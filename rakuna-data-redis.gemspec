...
# -*- encoding: utf-8 -*-
# stub: rakuna-data-redis 1.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rakuna-data-redis"
  s.version = "1.0.1"
  ...
  s.date = "2015-11-30"
  s.description = "Adds support for redis to your Webmachine project, with autodetection"
  ...
  s.files = [
    ...
    "rakuna-data-redis.gemspec",
    "spec/rakuna/data/redis_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = "http://github.com/colstrom/rakuna-data-redis"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5.1"
  s.summary = "Redis support for Rakuna"
